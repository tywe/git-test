...
public class MenuTree {
	 ...
	 * @return
	 */
	public List<Map<String, Object>> searchLeafMenus(
			List<Map<String, Object>> menuList) {
		if (null == menuList || menuList.size() == 0) {
			logger.error("menuList is null in search leaf", new Exception(
	...
	public Map<Integer, Object> transMenuType(List<Map<String, Object>> menuList) {
		if (null == menuList || menuList.size() == 0) {
			logger.error("menuList is null in transMenuType", new Exception(
					"null pointer exception"));
			return null;
		}
